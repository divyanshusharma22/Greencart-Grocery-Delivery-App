  ...
  return (
    <div className='relative'>
      ...
      <div className='flex items-center mt-6 font-medium'>
        <Link to={"/products"} className='group flex items-center gap-2 px-7 md:px-9 py-3 bg-green-600-600 hover:bg-green-600-600-dull transition rounded text-black cursor-pointer'>
        Shop now
